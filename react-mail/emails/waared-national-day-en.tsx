...
export const WaaredNationalDayEN = () => {
			...
			<Tailwind>
				<Body className="bg-white my-auto mx-auto font-sans px-2">
					<Container style={{ paddingTop: "30px", paddingBottom: "30px" }} className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto max-w-[600px]">
						...
						<Img
							src={`${baseUrl}/static/national-day-en.png`}
							alt="Waared"
							width="600"
							height="406"
							style={logo}
						...
						<Section style={{ paddingLeft: 62, paddingRight: 62 }} >
							...
							<Text style={{ color: "#262261", margin: 0 }}>
								On this occasion, we offer you a 20% discount on domestic shipments using the discount code 🎉 🇸🇦
							</Text>
...
export default WaaredNationalDayEN;
